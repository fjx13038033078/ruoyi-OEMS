 ...
 */
@Mapper
public interface ReinstatementApplicationMapper {
    /**
     * 获取所有复学申请
     *
     * @return 所有复学申请列表
     ...
     */
    int addReinstatementApplication(ReinstatementApplication reinstatementApplication);
     ...
     */
    int updateReinstatementApplication(ReinstatementApplication reinstatementApplication);
     ...
     * @return 更新成功返回影响的行数，否则返回0
     */
    int updateCollegeReview(ReinstatementApplication reinstatementApplication);
     ...
     * @return 更新成功返回影响的行数，否则返回0
     */
    int updateUniversityReview(ReinstatementApplication reinstatementApplication);
     ...
     */
    int deleteReinstatementApplication(Long applicationId);
