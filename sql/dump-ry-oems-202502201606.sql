...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='出境学习公告表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oe_announcement` VALUES (1,'通知','公告','2025-02-03 16:00:00','2025-02-20 16:00:00',1,1,'/profile/upload/2025/02/18/token_20250218093918A002.txt',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='学分置换申请表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oe_exchange_application` VALUES (1,1,2,'2025-02-20 15:02:50',0,1,'2025-02-20 15:34:51','通过',1,1,'2025-02-20 15:34:58','通过',1,1,6.00,'计算机',6.00);
...
CREATE TABLE `oe_outbound_application` (
  ...
  PRIMARY KEY (`application_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='学生出境学习申请表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oe_outbound_application` VALUES (3,1,1,'2025-02-18 15:40:20',1,'2025-02-19 15:24:21','通过',1,1,'2025-02-19 15:35:55','拒绝',2,'24-25-02',1,'计算机',0),(4,1,1,'2025-02-19 14:57:38',NULL,NULL,'通过',1,1,'2025-02-19 15:35:46','通过',1,'24-25-01',1,'数学',0);
...
CREATE TABLE `oe_reinstatement_application` (
  ...
  `university_review_result` tinyint DEFAULT NULL COMMENT '学校审核结果（0：待审核，1：通过，2：拒绝）',
  PRIMARY KEY (`application_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='学生复学申请表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oe_reinstatement_application` VALUES (1,1,4,'2025-02-20 09:42:57',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,1,4,'2025-02-20 10:05:29',0,NULL,1,'2025-02-20 10:11:30','通过',1,1,'2025-02-20 10:12:32','通过',1),(3,1,4,'2025-02-20 10:14:30',0,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,0),(4,1,4,'2025-02-20 10:17:33',0,'22-23-01',NULL,NULL,NULL,0,NULL,NULL,NULL,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='境外学校';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oe_university` VALUES (1,'耶鲁大学','美国');
...
) ENGINE=InnoDB AUTO_INCREMENT=267 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=293 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-02-20 16:06:30
