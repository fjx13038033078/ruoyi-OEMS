...
--
-- Table structure for table `oe_courses`
--

DROP TABLE IF EXISTS `oe_courses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oe_courses` (
  ...
  `institution` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '学校',
  PRIMARY KEY (`course_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `oe_courses`
--

LOCK TABLES `oe_courses` WRITE;
/*!40000 ALTER TABLE `oe_courses` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_courses` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='学分置换申请表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oe_exchange_application` VALUES (1,1,2,'2025-02-20 15:02:50',0,1,'2025-02-20 15:34:51','通过',1,1,'2025-02-20 15:34:58','通过',1,1,6.00,'计算机',6.00),(2,1,5,'2025-02-24 17:05:35',0,1,'2025-02-24 17:05:51','通过',1,1,'2025-02-24 17:05:58','通过',1,1,6.00,'计算机技术',6.00);
/*!40000 ALTER TABLE `oe_exchange_application` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oe_grades`
--

DROP TABLE IF EXISTS `oe_grades`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oe_grades` (
  `grade_id` bigint NOT NULL AUTO_INCREMENT COMMENT '成绩ID，主键，自增',
  `user_id` bigint NOT NULL COMMENT '学生ID，外键关联学生表',
  `course_id` bigint NOT NULL COMMENT '课程ID，外键关联境外课程表',
  `grade` decimal(5,2) NOT NULL COMMENT '成绩（支持百分制，0-100）',
...
--
-- Dumping data for table `oe_grades`
--

LOCK TABLES `oe_grades` WRITE;
/*!40000 ALTER TABLE `oe_grades` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_grades` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `oe_outbound_application` (
  ...
  PRIMARY KEY (`application_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='学生出境学习申请表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oe_outbound_application` VALUES (3,1,1,'2025-02-18 15:40:20',1,'2025-02-19 15:24:21','通过',1,1,'2025-02-19 15:35:55','拒绝',2,'24-25-02',1,'计算机',0),(4,1,1,'2025-02-19 14:57:38',NULL,NULL,'通过',1,1,'2025-02-19 15:35:46','通过',1,'24-25-01',1,'数学',0),(5,1,2,'2025-02-24 17:01:40',1,'2025-02-24 17:04:14','同意',1,1,'2025-02-24 17:04:21','同意',1,'24-25-01',2,'计算机技术',0);
...
CREATE TABLE `oe_reinstatement_application` (
  ...
  `university_review_result` tinyint DEFAULT NULL COMMENT '学校审核结果（0：待审核，1：通过，2：拒绝）',
  PRIMARY KEY (`application_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='学生复学申请表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oe_reinstatement_application` VALUES (1,1,4,'2025-02-20 09:42:57',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,1,4,'2025-02-20 10:05:29',0,NULL,1,'2025-02-20 10:11:30','通过',1,1,'2025-02-20 10:12:32','通过',1),(3,1,4,'2025-02-20 10:14:30',0,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,0),(4,1,4,'2025-02-20 10:17:33',0,'22-23-01',NULL,NULL,NULL,0,NULL,NULL,NULL,0),(5,1,5,'2025-02-24 17:04:31',0,'23-24-01',1,'2025-02-24 17:05:03','通过',1,1,'2025-02-24 17:05:09','通过',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=269 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2062 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='菜单权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=299 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-02-25 17:15:41
